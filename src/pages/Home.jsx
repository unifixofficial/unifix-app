      ...
      <section className="home-hero">
        <div className="home-hero-text">
          ...
          <div className="home-hero-actions">
            <a href="https://expo.dev/accounts/unifix-official/projects/unifix/builds/9919ff63-6542-4b18-8a16-89178a7a3413" className="home-btn-primary" target="_blank" rel="noopener noreferrer">Download App</a>
